...
Object.assign(ctx,{adminFleetAccess},swarmOps,fleetManifest,surveillance,openingRoute,{queueSwarmAircraft(){},operatorConcealed:()=>false,renderLiveSwarm(){node('#panel').innerHTML=swarmOps.renderSwarmOps({state:ctx.s,started:true});}});
