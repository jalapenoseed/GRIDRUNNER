...
Object.assign(ctx,swarmOps,fleetManifest,surveillance,openingRoute,{queueSwarmAircraft(){},operatorConcealed:()=>false,renderLiveSwarm(){node('#panel').innerHTML=swarmOps.renderSwarmOps({state:ctx.s,started:true});}});
