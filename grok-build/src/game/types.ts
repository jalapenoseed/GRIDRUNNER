...
export type Formation = "wedge" | "trail" | "line" | "orbit" | "ring";
...
export type DroneTask = "form" | "harvest" | "relay" | "recall" | "hold" | "intercept";
...
> = {
  scout: { mass: 2.4, speed: 14, label: "Scout", role: "Survey / FPV" },
  relay: { mass: 3.1, speed: 11, label: "Relay", role: "Radio hop" },
  utility: { mass: 4.6, speed: 8, label: "Utility", role: "Harvest" },
  cargo: { mass: 5.8, speed: 7, label: "Cargo", role: "Payload" },
};
