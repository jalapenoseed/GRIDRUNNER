...
A rebuilt backpack with 32 distinct item symbols, search and category filters, hover details, selected-item actions, and separate Workshop and Cargo pages. Clustered grass, scrub and oak groves soften the road edges; distance haze conceals the far geometry while preserving bright daylight. Quiet Start and all four Flight Yard airframes remain intact.
