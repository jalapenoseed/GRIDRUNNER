...
export function syncSensorSelection(settings,owner){
 ...
 if(settings.sensorOwner!==owner){
  if(SENSOR_PACKAGES[settings.sensorOwner])settings.sensorMemory[settings.sensorOwner]=sensorFor(settings.sensorOwner,settings.sensorMode);
