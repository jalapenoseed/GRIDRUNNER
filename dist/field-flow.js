...
export function rankedFieldPages(s,{nearTrailer=false}={}){const pages=[['map','Map','Route & power sites'],['inventory','Backpack','Items, tools & recovery'],['drones','Drones','Airframes & commands'],['journal','Journal','Clues & discoveries'],['rig','Mobile power','Bike, trailer & charging']];const rank={map:10,inventory:s.hp<50?60:20,drones:s.mode==='drone'?80:s.droneSystem?.hp<40?65:25,journal:s.relayHouse?.visited&&!s.relayHouse.discovered?50:15,rig:s.battery<25?70:nearTrailer?55:5};if(nearTrailer&&s.relayHouse?.schematicRead){pages.push(['workshop','Workshop','Known recipes & required parts']);rank.workshop=s.relayHouse.filterInstalled?30:75;}return pages.sort((a,b)=>rank[b[0]]-rank[a[0]]);}
