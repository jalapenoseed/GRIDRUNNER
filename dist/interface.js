...
export const MENU_GROUPS = Object.freeze([
  ...
  {id:'fleet',label:'Fleet',icon:'drones',target:'drones',pages:[['drones','Fleet operations','drones'],['flightyard','Flight Yard','tower'],['swarm','Swarm Command','drones'],['swarmProgram','Program swarm','drones'],['swarmLab','Formation lab','drones']]},
