...
export const MENU_GROUPS = Object.freeze([
  ...
  {id:'fleet',label:'Fleet',icon:'drones',target:'drones',pages:[['drones','Fleet operations','drones'],['fleetNetwork','Fleet network','map'],['fleetFinale','Fleet finale','day'],['flightyard','Flight Yard','tower'],['swarm','Swarm Command','drones'],['swarmProgram','Program swarm','drones'],['fleetCommander','Fleet Commander / 100','drones'],['swarmLab','Formation lab','drones']]},
