...
export function makePerson(x,z,c){
 ...
 combine(head);g.add(head);box(g,0,1.44,-.24,.45,.58,.21,0x303b37);box(g,0,1.55,-.36,.28,.13,.03,0xa79668);g.userData.head=head;g.userData.arms=arms;g.userData.legs=legs;g.position.set(x,0,z);return combine(g);
}
